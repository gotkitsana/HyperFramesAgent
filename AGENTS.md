...
> 📚 **Read `docs/` first for anything about HyperFrames** (concepts, CLI, the Rule of Three,
> components, templates, shaders, design rules, use cases, troubleshooting). Start at
> `docs/README.md`. Claude agents: see `CLAUDE.md`. Rendered video output lives in `out/` and is
